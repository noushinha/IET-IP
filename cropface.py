...
def faceCrop(imagePattern,boxScale=1):
    ...
    faceCascade = cv.CascadeClassifier('/media/Data/OpenFace/opencv-4.0.0/data/haarcascades/haarcascade_frontalface_alt.xml')
...
faceCrop('/media/Data/Datasets/AFEW/000029320/*.jpg',boxScale=1)